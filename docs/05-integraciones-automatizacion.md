...
| `expire-trials` | `supabase/functions/expire-trials/index.ts` | Cron: invoca RPC `expire_agency_trials()` para bajar agencias con trial vencido y sincronizar módulos. Programar en servidor (ver [16-planes-suscripcion-precios.md](16-planes-suscripcion-precios.md)). |
