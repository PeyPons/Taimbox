#!/bin/bash
# Script de deploy/actualización para Timeboxing
# Usa la rama 'main' en lugar de 'master'

set -e  # Salir si hay errores

echo "[$(date +'%H:%M:%S')] Descargando cambios de GitHub..."

# Cambiar al directorio del proyecto (ajustar según tu configuración)
