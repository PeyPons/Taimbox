...
export function LandingArticle() {
  ...
  return (
    <article id="por-que-timeboxing" className="relative z-10 max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-10 sm:py-14 md:py-16 text-left">
      {/* Bloque 1: El gancho */}
      <section className="mb-12 sm:mb-14">
        ...
        <h1 className="text-3xl sm:text-4xl md:text-5xl lg:text-[2.75rem] font-black text-white mb-6 leading-[1.15] tracking-tight text-center">
        ...
        <div className="space-y-4 text-indigo-100/95 text-base sm:text-lg leading-[1.75]">
          ...
          <div className="rounded-2xl border-l-4 border-indigo-400 bg-indigo-500/10 border border-indigo-500/20 p-5 sm:p-6 my-6">
      ...
      <section className="mb-12 sm:mb-14">
        <div className="rounded-2xl border border-white/10 bg-white/5 backdrop-blur-sm p-6 sm:p-8 mb-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4 sm:gap-5">
          <div className="rounded-2xl border border-indigo-500/30 bg-gradient-to-br from-indigo-900/70 to-purple-900/50 p-6 flex flex-col shadow-lg shadow-indigo-950/50 hover:border-indigo-400/40 transition-colors">
          ...
          <div className="rounded-2xl border border-purple-500/30 bg-gradient-to-br from-purple-900/70 to-pink-900/50 p-6 flex flex-col shadow-lg shadow-purple-950/50 hover:border-purple-400/40 transition-colors">
          ...
          <div className="rounded-2xl border border-amber-500/30 bg-gradient-to-br from-amber-900/70 to-orange-900/50 p-6 flex flex-col shadow-lg shadow-amber-950/50 hover:border-amber-400/40 transition-colors">
      ...
      <section className="mb-12 sm:mb-14">
        <div className="rounded-2xl border border-amber-500/20 bg-amber-950/30 backdrop-blur-sm p-6 sm:p-8 mb-6">
          <h2 className="text-2xl sm:text-3xl md:text-4xl font-bold text-white mb-4">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
          <div className="rounded-2xl border border-amber-500/30 bg-gradient-to-br from-amber-900/50 to-orange-900/30 p-6 flex flex-col">
            <div className="w-10 h-10 rounded-lg bg-amber-500/30 flex items-center justify-center mb-4">
              <AlertTriangle className="h-5 w-5 text-amber-400" />
            </div>
            <h4 className="text-white font-semibold mb-2">La paradoja del festivo</h4>
          ...
          <div className="rounded-2xl border border-amber-500/30 bg-gradient-to-br from-amber-900/50 to-orange-900/30 p-6 flex flex-col">
            ...
            <h4 className="text-white font-semibold mb-2">La doble contabilidad</h4>
            <p className="text-sm text-indigo-200/85 leading-relaxed">
          ...
          <div className="rounded-2xl border border-amber-500/30 bg-gradient-to-br from-amber-900/50 to-orange-900/30 p-6 flex flex-col">
            ...
            <h4 className="text-white font-semibold mb-2">El muro financiero</h4>
            <p className="text-sm text-indigo-200/85 leading-relaxed">
              Tu calendario dice «Diseñar Home (4h)», pero no te dice que esas 4 horas cuestan 200€ de nómina y el cliente solo paga 150€.
            </p>
          </div>
        </div>
        <div className="mt-6 rounded-2xl border-l-4 border-indigo-400 bg-indigo-500/10 border border-indigo-500/20 p-5 sm:p-6">
      ...
      <section className="mb-12 sm:mb-14">
        <div className="rounded-2xl border border-indigo-500/20 bg-indigo-950/40 backdrop-blur-sm p-6 sm:p-8 mb-6">
          <h2 className="text-2xl sm:text-3xl md:text-4xl font-bold text-white mb-4">
        ...
        <div className="space-y-8">
          <div className="rounded-2xl border border-indigo-500/25 bg-white/5 p-6 sm:p-8">
            <div className="flex items-center gap-3 mb-4">
              <span className="flex h-9 w-9 items-center justify-center rounded-lg bg-indigo-500/30 text-indigo-300 font-bold text-sm">1</span>
            ...
            <ul className="space-y-3 mb-6 text-indigo-100/90">
              <li className="flex gap-3">
                <span className="text-indigo-400 font-medium shrink-0">Semanas partidas:</span>
                <span>Si una semana laboral empieza en enero y acaba en febrero, el sistema divide los costes proporcionalmente para que tu cierre de mes sea exacto al céntimo.</span>
              </li>
              <li className="flex gap-3">
                <span className="text-indigo-400 font-medium shrink-0">Gestión de capacidad real:</span>
                <span>Utilizamos una lógica de Max(Ausencia, Evento) para calcular la disponibilidad. Si es festivo y alguien está enfermo, el sistema sabe que no se pierden el doble de horas.</span>
              </li>
            </ul>
            <div className="rounded-xl border border-indigo-500/30 bg-indigo-950/60 p-4 min-h-[320px]">
          ...
          <div className="rounded-2xl border border-indigo-500/25 bg-white/5 p-6 sm:p-8">
            ...
            <ul className="flex flex-wrap gap-3 text-indigo-100/90 justify-center">
      ...
      <section className="mb-12 sm:mb-14">
        ...
        <div className="space-y-4 mb-6">
          <div className="rounded-xl border border-indigo-500/25 bg-indigo-950/40 p-5 flex gap-4">
          ...
          <div className="rounded-xl border border-emerald-500/25 bg-emerald-950/30 p-5 flex gap-4">
          ...
          <div className="rounded-xl border border-amber-500/25 bg-amber-950/30 p-5 flex gap-4">
        ...
        <div className="rounded-2xl border border-indigo-500/30 bg-slate-950/90 overflow-hidden shadow-xl">
          <Tabs value={apiTab} onValueChange={(v) => setApiTab(v as 'curl' | 'js')}>
            <TabsList className="w-full justify-start rounded-none border-b border-white/10 bg-slate-900/90 p-0 h-auto">
            ...
            <TabsContent value="js" className="m-0 p-5">
              <p className="text-xs text-slate-400 mb-2 font-medium">Obtener rentabilidad por proyecto (paso 2 del tutorial de reportes)</p>
              <pre className="p-4 rounded-lg bg-slate-900 text-sm text-slate-200 overflow-x-auto font-mono leading-relaxed border border-white/5">
...
const report = projects?.map(p => {
  ...
  return {
    ...
    hourValue: \`\${hourValue} EUR/h\`
            ...
            <TabsContent value="curl" className="m-0 p-5">
