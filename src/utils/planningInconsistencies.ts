import { Allocation, Client, Deadline, Employee, Project } from '@/types';
...
export function computeGlobalPlanningInconsistencies(params: {
  ...
  monthAllocations.forEach(a => {
    ...
    if (a.status === 'completed') {
      allocationsByProjectAndEmployee[a.projectId][a.employeeId].computed += getEffectiveCompletedHours(a, effectivePreference);
    } else {
