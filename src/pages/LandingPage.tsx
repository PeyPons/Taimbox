        ...
        <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-4 sm:py-6">
          ...
          {(() => {
            const features = [
              ...
              { icon: BarChart3, label: 'Métricas', color: 'from-rose-500 to-pink-500', title: 'Métricas y Analytics', subtitle: 'Decisiones basadas en datos', description: 'Seguimiento operativo, Rentabilidad, Capacidad de Equipo y Reportes clásicos (índice de fiabilidad, tendencias). Informes PDF e integración API.', featureList: ['Índice de fiabilidad', 'Productividad por equipo', 'Tendencias históricas', 'Informes PDF e integración API'], example: 'Tu índice de fiabilidad es del 78%. Históricamente, subestimas proyectos de diseño en un 20%. Ahora lo sabes y puedes ajustar.', stat: '+78%', statLabel: 'precisión en estimaciones', landingUrl: '/reportes-rentabilidad' },
            ];
