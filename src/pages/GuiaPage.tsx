  ...
  return (
    <>
      <ContentBlock title="Qué son los Informes">
        <p>Los Informes agrupan <strong className="text-white">reportes por cliente, por proyecto y métricas globales</strong>. Permiten exportar datos y ver tendencias históricas de horas, cumplimiento y productividad.</p>
      </ContentBlock>

      <ContentBlock title="Secciones disponibles">
        <div className="grid sm:grid-cols-2 gap-3">
          <FeatureCard icon={BarChart3} title="Dashboard de informes" description="Resumen por período con gráficos de horas estimadas vs reales, desglose por proyectos y empleados." color="from-indigo-500 to-blue-500" />
          <FeatureCard icon={Activity} title="Coherencia global" description="Vista de todas las variaciones (deadline vs planificado) del equipo, agrupadas por proyecto." color="from-amber-500 to-orange-500" />
          <FeatureCard icon={Download} title="Exportación" description="Descarga en Excel, CSV o JSON según permisos y tipo de informe. Datos históricos completos." color="from-emerald-500 to-teal-500" />
          <FeatureCard icon={Filter} title="Filtros" description="Acota por fecha, cliente, proyecto y empleado para obtener exactamente los datos que necesitas." color="from-purple-500 to-pink-500" />
        </div>
      </ContentBlock>
