...
| [docs/05-integraciones-automatizacion.md](docs/05-integraciones-automatizacion.md) | Edge Functions (inventario, OAuth Google/Meta, emails, modo demo), `delete-user`, `admin-delete-agency`, Stripe, variables de entorno, despliegue y troubleshooting. |
