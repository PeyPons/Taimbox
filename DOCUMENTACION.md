...
### 1.1 Reglas de Páginas Públicas y SEO
...
- **Campos en `agencies`:** `plan_id` (starter/pro/business/enterprise), `subscription_status`, `stripe_customer_id`, `stripe_subscription_id`, `trial_ends_at`, `subscription_period_ends_at`, `subscription_cancel_at_period_end`, `trial_used_at`. Migraciones: `20260228120000_add_agency_billing.sql`, `…140000…period_end.sql`, `…150000…cancel_at_period_end.sql`, `…160000…trial_used_at.sql`, `20260301230000_add_enterprise_plan.sql`.
